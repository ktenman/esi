package ee.ut.library.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import ee.ut.library.IntegrationTest;
import ee.ut.library.repository.timezone.DateTimeWrapper;
import ee.ut.library.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM esi_date_time_wrapper where id=%d", fieldName, id);
    }
